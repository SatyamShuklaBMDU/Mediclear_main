                        ...
                        <div class="row mb" style="margin-bottom: 30px;">
                            ...
                            <div class="col-sm-3 end-date">
                                ...
                                <div class="input-group date d-flex" id="datepicker2">
                                    <input type="date" name="end" class="form-control" value="{{ $end ?? ''}}" id="enddate" placeholder="dd-mm-yyyy" />
                                </div>
                            </div>
...
@endphp
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> <img src="{{asset('public/customer/'.$customer->customer_profile_image_name)}}" width="40px" alt=""> </td>
