...
<div class="container-fluid">
    ...
    <div class="col-sm-2" style="position: relative; top: 47px;">
        <div class="Click-here"> <button class="btn  bg-gradient-success   text-white shadow-lg" type="button"
                style="padding: 4px 4px; font-size:17px; width:165px;" data-target="#mymodel" data-toggle="modal"> Add
                Company</button>
            <!-- poppux box start -->
                ...
                <div class="modal-dialog m-auto">
                    <div class="modal-content">
                        <div class="modal-header">
                            <form action="{{ url('/create-company') }}" method="post" class="text-center">
                                @csrf
                                ...
                                <input type="text" required style="margin-bottom:10px;" name="city" /> <br />
                                <label for="">Email ID &nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;</label>
        ...
        <tbody>
            ...
            @foreach ($company as $company)
                <tr>
                    ...
                    <td> <i class="fa-solid fa-pen-to-square text-success" <i
                            class="fa-solid fa-pen-to-square text-success" style="cursor: pointer"
                            data-toggle="modal" data-target="#exampleModal1" style="font-size:1rem;"
                            onclick="{document.getElementById('id').value={{ $company->id }}; document.getElementById('name').value='{{ $company->name }}'; document.getElementById('email').value='{{ $company->email }}'; document.getElementById('mobile_no').value={{ $company->mobile_no }}; document.getElementById('city').value='{{ $company->city }}';}"></i>
