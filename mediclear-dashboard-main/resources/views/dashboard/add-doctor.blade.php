                            ...
                            <table id="example" class="display nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$doctor->name}} </td>
                                        <td>{{$doctor->post}}</td>
                                        <td> <img src="{{asset('/images/'.$doctor->sign)}}" width="100px" alt=""> </td>
                                        {{-- <td>MED001</td> --}}
                                        {{-- <td>*********23</td> --}}
                                        ...
                                        <td> <i class="fa-solid fa-pen-to-square text-success" style="font-size:1rem;"></i> &nbsp; <i class="fa-solid fa-trash text-danger"    data-toggle="modal" data-target="#exampleModal"
