...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('consumer_medical_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('gender', ['male', 'female', 'others'])->default('null');
    ...
    {
        Schema::dropIfExists('consumer_medical_details');
    }
};
